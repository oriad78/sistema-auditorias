...
TEMPLATE_AUDITORIA = [
    ...
    ("100 - Aceptación y continuación de clientes", "4000", "(ISA 200, 220, 300) Considerar el cumplimiento de requisitos éticos e independencia.", "Instrucciones: Completar confirmaciones de independencia."),
